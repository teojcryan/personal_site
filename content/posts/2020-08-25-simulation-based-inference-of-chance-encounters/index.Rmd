...
ggplot(data.frame(met_null), aes(x=x)) + 
  geom_histogram(binwidth=1, fill="#69b3a2") +
  ggtitle("Frequency of no. of non-interactions") +
  labs(x = " Number of non-interactions") + 
  theme_bw()
```
...
```{r, echo=F, out.width = "100%"}
ggplot(data.frame(counts), aes(x=x)) + 
  geom_histogram(binwidth=1, fill="#69b3a2") +
  ggtitle("Frequency of no. of breakout rounds needed") +
  labs(x = "Number of breakout rounds needed for all fellows to meet") + 
  theme_bw()
```
